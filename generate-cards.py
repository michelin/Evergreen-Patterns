...
michelin_font = ImageFont.truetype("static/fonts/Michelin-SemiBold.ttf", size=44)
font = ImageFont.truetype("static/fonts/Swansea-q3pd.ttf", size=36)
font_spacing_y = 6
...
generate_cards(data.patterns)
generate_cards(data.anti_patterns)